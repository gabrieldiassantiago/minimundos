...
<mx:MXML
	...
	<mx:Script>
		<![CDATA[
			...
			{
				kick = createPiece("inst_drum_02_drumkick.png");
				snare = createPiece("drum_snare.png");
				hiHat = createPiece("deluxedrum_hi_hat.png");
				tomLeft = createPiece("inst_drum_02_tomleft.png");
				tomRight = createPiece("inst_drum_02_tomright.png");
				tomBottom = createPiece("drum_tom_bottom.png");
				crash = createPiece("deluxedrum_crash.png");
				ride = createPiece("deluxedrum_ride.png");
